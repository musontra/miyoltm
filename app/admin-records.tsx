...
export default function AdminRecordsScreen() {
  ...
  function getEntryCount(userId: string) {
    return nutritionEntries.filter(e => e.userId === userId).length;
  }
    ...
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TouchableOpacity
            style={styles.item}
            onPress={() => router.push({ pathname: '/admin-records/[userId]', params: { userId: item.id } })}
            activeOpacity={0.75}
          >
